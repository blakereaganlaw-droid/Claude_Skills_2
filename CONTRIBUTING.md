...
## Build status (waves)
All seven waves are complete: **80 skills across 13 plugins**, `validate.sh` clean.
...
- **Wave 6 — Sponsored projects AR:** ✅ `sponsored-projects-ar-skills` (8): master router,
  ...
  billing/cash management (LOC/PMS draws), and effort reporting basics.
