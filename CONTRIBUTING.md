...
## Build status (waves)
All seven waves are complete: **81 skills across 13 plugins**, `validate.sh` clean.
...
- **Wave 6 — Sponsored projects AR:** ✅ `sponsored-projects-ar-skills` (9): master router,
  PPM-to-AR domain knowledge, unbilled/billed WIP reconciliation, KPIs & trend forecasts,
  reporting & recommendations, plus federal compliance — Uniform Guidance core, federal
  billing/cash management (LOC/PMS draws), effort reporting basics, and compliance/audit
  risk assessment.
